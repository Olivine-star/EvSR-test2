...
class NetworkBasic(torch.nn.Module):
    ...
    def __init__(self, netParams,
        ...
        self.conv1 = self.slayer1.conv(1, 10, 5, padding=2)
        self.conv2 = self.slayer2.conv(10, 10, 3, padding=1)
        self.upconv1 = self.slayer3.convTranspose(10, 1, kernelSize=2, stride=2)
