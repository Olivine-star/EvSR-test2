...
import time
total_time = 0.0
log_file = open(os.path.join(savepath, 'inference_log.txt'), 'w')
...
# 总时间统计
msg = f" Total inference time: {total_time:.2f} seconds"
print(msg)
print(msg, file=log_file, flush=True)

msg = f" Average inference time per sample: {total_time / len(testLoader) * 1000:.2f} ms"
print(msg)
print(msg, file=log_file, flush=True)
